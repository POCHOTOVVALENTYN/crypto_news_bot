...
Предложение 1: главный факт (кто, что сделал, цифры).
Предложение 2: почему это произошло или контекст.
Предложение 3 (по желанию): вывод для инвестора.
{length_req}.
СТРОГО ЗАПРЕЩЕНО: любые списки, любые эмодзи, любые заголовки, жирный текст (**), курсив (__). Только чистый текст.
СТРОГО ЗАПРЕЩЕНО: артефакты типа "**🐦**" или "🐦". Убирай их полностью.

ВЫВЕДИ ТОЛЬКО ТЕКСТ. Без пояснений."""
        else:
